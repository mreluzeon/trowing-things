...
return (new CustomEvent(event_name,(function (){var obj26738 = {"detail":data};
return obj26738;
})()));
} else {
...
var f = (function (){var pred__26745 = cljs.core._EQ_;
var expr__26746 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__26745.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__26746))){
return ((function (pred__26745,expr__26746){
return (function (p1__26739_SHARP_){
return console.warn(p1__26739_SHARP_);
});
;})(pred__26745,expr__26746))
} else {
if(cljs.core.truth_(pred__26745.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__26746))){
return ((function (pred__26745,expr__26746){
return (function (p1__26740_SHARP_){
return console.debug(p1__26740_SHARP_);
});
;})(pred__26745,expr__26746))
} else {
if(cljs.core.truth_(pred__26745.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__26746))){
return ((function (pred__26745,expr__26746){
return (function (p1__26741_SHARP_){
return console.error(p1__26741_SHARP_);
});
;})(pred__26745,expr__26746))
} else {
return ((function (pred__26745,expr__26746){
return (function (p1__26742_SHARP_){
return console.log(p1__26742_SHARP_);
});
;})(pred__26745,expr__26746))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__26749){
...
var eval_fn = cljs.core.get.call(null,map__26750__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__26752_SHARP_);
});})(new_def))
);
...
return (function (p__26753){
var vec__26754 = p__26753;
var ky = cljs.core.nth.call(null,vec__26754,(0),null);
var v = cljs.core.nth.call(null,vec__26754,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1539278418191
