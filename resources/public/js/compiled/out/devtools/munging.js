...
var o29975 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29975["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29976 = temp__5455__auto____$1;
return (o29976["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29087__auto__ = f;
return (o__29087__auto__["toString"]).call(o__29087__auto__);
} else {
return "";
}
}catch (e29977){var _ = e29977;
return "";
}});
...
try{var o__29087__auto___29979 = t;
(o__29087__auto___29979["cljs$lang$ctorPrWriter"]).call(o__29087__auto___29979,t,writer);
}catch (e29978){var __29980 = e29978;
}
...
var char_code = (function (){var o__29087__auto__ = (new String(char$));
return (o__29087__auto__["charCodeAt"]).call(o__29087__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29087__auto__ = String;
return (o__29087__auto__["fromCharCode"]).call(o__29087__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29981 = num_code;
switch (G__29981) {
case (1):
return (185);
...
var o__29087__auto__ = String;
return (o__29087__auto__["fromCharCode"]).call(o__29087__auto__,superscript_code);
});
/**
...
}catch (e29983){var _e__29094__auto__ = e29983;
return false;
}})())){
...
var vec__29984 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29984,(0),null);
...
var temp__5455__auto____$1 = (o29987["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29988 = temp__5455__auto____$1;
return (o29988["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___29995 = arguments.length;
var i__4500__auto___29996 = (0);
while(true){
if((i__4500__auto___29996 < len__4499__auto___29995)){
args__4502__auto__.push((arguments[i__4500__auto___29996]));

var G__29997 = (i__4500__auto___29996 + (1));
i__4500__auto___29996 = G__29997;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29991){
var vec__29992 = p__29991;
var ns_detector = cljs.core.nth.call(null,vec__29992,(0),null);
...
var G__29998 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29999 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29998;
remaining_tokens = G__29999;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29989){
var G__29990 = cljs.core.first.call(null,seq29989);
var seq29989__$1 = cljs.core.next.call(null,seq29989);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29990,seq29989__$1);
});
...
var vec__30003 = cljs.core.split_with.call(null,(function (p1__30002_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30002_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30003,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30003,(1),null);
...
var vec__30006 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30006,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30006,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30009 = cljs.core.rest.call(null,remaining_tokens);
var G__30010 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30009;
name_tokens = G__30010;
continue;
} else {
...
var vec__30013 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30013,(0),null);
var arity = cljs.core.nth.call(null,vec__30013,(1),null);
var vec__30016 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30016,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30016,(1),null);
var vec__30019 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30019,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30019,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30019,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30019,(3),null);
...
var vec__30025 = result;
var munged_ns = cljs.core.nth.call(null,vec__30025,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30025,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30025,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30025,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30025,(4),null);
var arity = cljs.core.nth.call(null,vec__30025,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__30029 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__30029,(0),null);
var args = cljs.core.nth.call(null,vec__30029,(1),null);
var vec__30032 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__30032,(0),null);
var name = cljs.core.nth.call(null,vec__30032,(1),null);
...
var G__30035 = (arity + (1));
var G__30036 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30037){
var vec__30038 = p__30037;
var arity = cljs.core.nth.call(null,vec__30038,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30038,(1),null);
...
return cljs.core.get.call(null,arities,p1__30041_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__30042_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30045){
var vec__30046 = p__30045;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30046,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30043){
var G__30044 = cljs.core.first.call(null,seq30043);
var seq30043__$1 = cljs.core.next.call(null,seq30043);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30044,seq30043__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30054__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30054__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30054__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30054__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30055 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30055,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30055,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30055,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30055,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30055,(4),null);
var arity = cljs.core.nth.call(null,vec__30055,(5),null);
...
var o__29087__auto__ = f;
return (o__29087__auto__["getBasis"]).call(o__29087__auto__);
});
/**
...
}catch (e30059){var _e__29094__auto__ = e30059;
...
var G__30060 = (obj[cljs.core.first.call(null,path)]);
var G__30061 = cljs.core.rest.call(null,path);
obj = G__30060;
path = G__30061;
continue;
} else {
...
return (function (accum,p__30062){
var vec__30063 = p__30062;
var bit = cljs.core.nth.call(null,vec__30063,(0),null);
var protocol = cljs.core.nth.call(null,vec__30063,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30066){
var vec__30067 = p__30066;
var ns = cljs.core.nth.call(null,vec__30067,(0),null);
var name = cljs.core.nth.call(null,vec__30067,(1),null);
var selector = cljs.core.nth.call(null,vec__30067,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__30072,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30072,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__30072,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__30070_SHARP_){
return (obj[cljs.core.first.call(null,p1__30070_SHARP_)]);
});})(name,sorted_matches,vec__30072,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1539278426220
