...
/** @this {Function} */
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30103){
...
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30104,G__30105,seq30103__$2);
});
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30109_SHARP_){
return !((cljs.core.meta.call(null,p1__30109_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__30110__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30114){var _e__29094__auto__ = e30114;
return false;
}})();
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
...
}catch (e30116){var _e__29094__auto__ = e30116;
return false;
}}
})())){
...
var _STAR_current_state_STAR_30118 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__30119 = opts;
...
var markup_db = cljs.core.get.call(null,map__30119__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_30118;
}});
...
;
var temp__5455__auto___30123 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5455__auto___30123)){
var managed_print_level_30124 = temp__5455__auto___30123;
var _STAR_print_level_STAR_30122_30125 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_30124;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_30122_30125,managed_print_level_30124,temp__5455__auto___30123,writer,opts,job_fn){
return (function (p1__30121_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__30121_SHARP_,null);
});})(_STAR_print_level_STAR_30122_30125,managed_print_level_30124,temp__5455__auto___30123,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_30122_30125;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1539278426658
